...
export default function StickyMobile() {
  ...
  useEffect(() => {
    ...
    if (!el) return
    // IntersectionObserver avoids forced reflow caused by getBoundingClientRect in scroll handlers.
    // rootMargin shrinks the detection zone to the top half of the viewport: hide bar when
    // the contact section enters the upper 50% of the screen.
  ...
  return (
    ...
    >
      <div className="flex border-t border-[#c9a96e]/20 bg-[#080808]/95 backdrop-blur-md">
        <a
